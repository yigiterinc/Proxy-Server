...
public class Proxy implements Runnable {
	...
	public void listen() {
		...
		while (running) {
			try {
				...
				// Socket exception is triggered by management system to shut
				// down the proxy
	 ...
	 * configurations blocked : Lists currently blocked sites close : Closes the
	 * proxy server * : Adds * to the list of blocked sites
	 */
	@Override
	public void run() {
